    ...
    <div className="Location">
        <div className="text"><br></br>
            ...
            <h1>Climbing Sessions</h1>
                ...
                Our club meets every Thursday 
                and Sunday to connect and climb.
                <a  target="_blank" href=
                    "https://www.google.com/maps/place/Geary+F.+Eppley+Recreation+Center,+4128+Valley+Dr,+College+Park,+MD+20742/@38.9935511,-76.9496274,16.31z"
                    ><img src={button}></img>
                </a>
        </div>
